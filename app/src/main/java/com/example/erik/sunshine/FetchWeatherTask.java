...
import com.example.erik.sunshine.data.WeatherProvider;
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    private static String API_KEY = "137eb3c9ef0d0947c57b8b4fed2c46fd";
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        Log.d(LOG_TAG, "getWeatherDataFromJson: "+forecastJsonStr );
